        ...
        <div class="container">
            ...
            <el-dialog title="添加故障单" :visible.sync="addDialog" width="35%">
                <el-form :model="addForm"  :rules="addRules" >
                    <el-form-item label="故障标题" :label-width="formLabelWidth" prop="title">
                    ...
                    <el-form-item label="故障应用" :label-width="formLabelWidth" prop="application">
                        <el-select v-model="addForm.application" placeholder="请选择故障应用" style="width:250px">
                            <el-option label="故障1" value="faultOne"></el-option>
                            <el-option label="故障2" value="faultTwo"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="故障时间" :label-width="formLabelWidth" prop="time">
                        <el-date-picker
                            style="width:250px"
                ...
                <div slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click="addDialog = false">确认上报</el-button>
                </div>
            </el-dialog>
